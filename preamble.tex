...
\newtoggle{resume}  \togglefalse{resume}
...
\address{}{Santa Clara, CA, 95050}    % optional
\phone{217.979.0918}                                   % optional
%\phone{925-424-6263}                                  % optional
%\fax{fax (optional)}                                  % optional
\email{nikhil.jain@acm.org}                              % optional

\extrainfo{\href{http://nikhil-jain.github.io}{\url{http://nikhil-jain.github.io/}}}
...
\newcommand{\repSecTitle}
  {}
\newcommand{\paperSecTitle}
  {\bibsectiontitleformat{Peer Reviewed Conference \& Journal Papers}}
\newcommand{\workshopSecTitle}
  {\bibsectiontitleformat{Workshop Papers}}
\newcommand{\bookSecTitle}
  {\bibsectiontitleformat{Special Issues, Book Chapters, Articles}}
\newcommand{\phdSecTitle}
  {\bibsectiontitleformat{Ph.D. Dissertation}}
\newcommand{\posterSecTitle}
  {\bibsectiontitleformat{Posters}}
\newcommand{\tutorialSecTitle}
  {\bibsectiontitleformat{Tutorials}}

\newcites{Rep,Paper,Workshop,Book,PhD,Poster,Tutorial}{
	\repSecTitle,\paperSecTitle,\workshopSecTitle,\bookSecTitle,\phdSecTitle,\posterSecTitle,\tutorialSecTitle}
